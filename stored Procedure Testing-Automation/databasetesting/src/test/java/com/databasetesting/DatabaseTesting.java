...
public class DatabaseTesting {
    ...
    void testStoredProcedureExists() throws SQLException {
        ...
        List<String> l=List.of("GetCustomerShipping","get_order_by_cust","InsertSupplierProduct","SelectAllCustomers","SelectAllCustomersByCity","selectAllCustomersByCityAndPin");
        int count=0;
        while(rs.next()){
